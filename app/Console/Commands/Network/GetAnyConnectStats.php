...
class GetAnyConnectStats extends Command
{
    ...
    {	
		...
		if(env("ASA_ARRAY")){
			...
			print "No ASAs found in .env file. Ending Command Tasks".PHP_EOL; 
			return; 
		}
		...
		if(env("ELASTIC_URL") && env("ELASTIC_USER") && env("ELASTIC_PASS")){
			...
			print $elasticUrl.PHP_EOL; 
			
		}else{
			print "No Elastic URL to write data".PHP_EOL; 
			return; 
		}
