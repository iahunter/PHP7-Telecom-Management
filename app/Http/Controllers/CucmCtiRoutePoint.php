...
class CucmCtiRoutePoint extends Cucm
{
    ...
    public function deleteCtiRoutePointbyName($NAME)
    {
        $user = JWTAuth::parseToken()->authenticate();
        // Check user permissions
    ...
    // Create New CtiRoutePoint
    public function createCtiRoutePoint(Request $request)
    {
        $user = JWTAuth::parseToken()->authenticate();
        // Check user permissions
        if (! $user->can('create', Cucmclass::class)) {
        ...
        */
        ...
        $result = $this->provision_cucm_ctiroutepoint_axl(
                                                $SITE,
                                                $DEVICE,
                                                $NAME,
                                                $FIRSTNAME,
    ...
    private function provision_cucm_ctiroutepoint_axl(
                                                $SITE,
                                                $DEVICE,
                                                $NAME,
                                                $FIRSTNAME,
