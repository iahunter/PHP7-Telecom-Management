...
class Phoneplan extends Model
{
    ...
    protected $fillable = ['site', 'name', 'description', 'status', 'system_id', 'notes', 'language', 'employee_vm_user_template', 'nonemployee_vm_user_template', 'json', 'created_by', 'updated_by', 'deleted_by'];
