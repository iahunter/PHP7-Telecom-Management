...
class Site extends Model
{
    ...
    protected $fillable = ['sitecode', 'e911', 'trunking', 'srstip', 'h323ip', 'npa', 'nxx', 'timezone', 'operator', 'comment', 'didrange', 'didblocks', 'details', 'extlen', 'languages', 'created_by', 'updated_by'];
