angular
	.module('app')
	.controller('MyMacdWeekly.Controller', ['macdService','$location', '$interval', '$state', '$scope', '$stateParams', function(macdService, $location, $interval, $state, $scope,$stateParams) {
		...
		function getmyweeksmacdslog(){
			macdService.list_my_macd_parents_for_week()
				.then(function(res){
		...
		var pulllogactivity = $interval(getmyweeksmacdslog,60000); 
